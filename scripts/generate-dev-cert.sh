...
#   PHANERIS_RPC_TLS_CERT=certs/cert.pem PHANERIS_RPC_TLS_KEY=certs/key.pem bun run server:dev
...
echo "  PHANERIS_RPC_TLS_CERT=$OUT_DIR/cert.pem PHANERIS_RPC_TLS_KEY=$OUT_DIR/key.pem bun run server:dev"
