#!/usr/bin/env bash
# install-server.sh — Set up the Phaneris standalone server.
#
# Usage:
...
echo ""
echo "  PHANERIS_SERVER_TOKEN=\"\$(cat $TOKEN_FILE)\" \\"
echo "  PHANERIS_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  PHANERIS_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
...
echo "  PHANERIS_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  PHANERIS_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  PHANERIS_RPC_HOST=0.0.0.0 \\"
echo "  PHANERIS_RPC_PORT=9100 \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
...
echo "  PHANERIS_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  PHANERIS_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  PHANERIS_RPC_TLS_CERT=/path/to/cert.pem \\"
echo "  PHANERIS_RPC_TLS_KEY=/path/to/key.pem \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
