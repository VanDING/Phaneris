...
- [x] Credential encryption key can come from Electron safeStorage or `PHANERIS_CREDENTIAL_KEY` instead of the machine-id fallback.
...
- [ ] Crash reporting is opt-in (`PHANERIS_TELEMETRY_ENABLED=1` plus a DSN).
