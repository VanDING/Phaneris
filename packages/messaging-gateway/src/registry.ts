...
import type { PushTarget } from '@phaneris/shared/protocol'
import type { CredentialManager } from '@phaneris/shared/credentials'
import type {
  ISessionManager,
...
export interface MessagingGatewayRegistryOptions {
  ...
  whatsapp?: {
    /** Absolute path to the worker entry (packaged/unpacked from @phaneris/messaging-whatsapp-worker). */
    workerEntry: string
