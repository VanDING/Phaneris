 ...
 * `@phaneris/messaging-whatsapp-worker` subprocess.
 *
 ...
 *
 * The worker contract is defined in @phaneris/messaging-whatsapp-worker.
...
import {
  ...
  type WorkerCommand,
  type WorkerEvent,
} from '@phaneris/messaging-whatsapp-worker'
import type {
  PlatformAdapter,
  PlatformConfig,
  AdapterCapabilities,
