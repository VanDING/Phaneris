...
declare const PHANERIS_AGENT_CLI_VERSION: string | undefined;

export function getCurrentVersion(): string {
  if (typeof PHANERIS_AGENT_CLI_VERSION !== 'undefined' && PHANERIS_AGENT_CLI_VERSION != null) {
    return PHANERIS_AGENT_CLI_VERSION;
  }
  return "0.0.1";
}
