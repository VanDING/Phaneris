...
describe('classifyExternalUrl — internal deep links', () => {
  it('classifies phaneris:// as internal-deeplink', () => {
    expect(classifyExternalUrl('phaneris://settings').kind).toBe('internal-deeplink')
  })
...
describe('formatBlockedUrlError', () => {
  ...
  it('returns an empty string for non-dangerous classifications', () => {
    ...
    expect(formatBlockedUrlError(classifyExternalUrl('phaneris://settings'))).toBe('')
  })
})
...
describe('isSafeExternalUrl', () => {
  ...
  it('returns false for internal deep links', () => {
    expect(isSafeExternalUrl('phaneris://settings')).toBe(false)
  })
