...
import type { SessionToolContext } from '@phaneris/session-tools-core';
...
export function attachSessionSelfManagementBindings(
  ...
  Object.defineProperty(context, 'updateSessionPlanning', {
    get() {
      return getSessionScopedToolCallbacks(sessionId)?.updateSessionPlanningFn;
    },
    configurable: true,
    enumerable: true,
  });
