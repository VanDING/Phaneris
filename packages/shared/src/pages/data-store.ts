 ...
 *   that is why it is exported solely as the '@phaneris/shared/pages/data-store'
 *   subpath and deliberately NOT re-exported from '@phaneris/shared/pages'.
...
import type { PageDataSnapshot, PageSeriesPoint } from '@phaneris/core';
