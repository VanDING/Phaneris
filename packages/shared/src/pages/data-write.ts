...
import { resolveScriptRuntime } from '@phaneris/session-tools-core';
import type { PageConfig, PageDataSnapshot } from '@phaneris/core';
...
export function buildPageDataWriterScript(input: {
  ...
  return `// Generated by @phaneris/shared/pages/data-write — self-contained on purpose.
