 ...
 *
 * The domain/protocol types live in @phaneris/core (renderer-safe); this
 * module re-exports them and adds the storage-layer shapes that carry
 * absolute paths or creation inputs.
 *
 * File structure: see the docblock in @phaneris/core types/page.ts.
 */

import type { PageActionGrant, PageConfig, PageKind, PageRefreshSpec } from '@phaneris/core';

// Re-export the core page types so consumers can import everything from
// '@phaneris/shared/pages' (mirrors how sources/projects expose types).
export type {
  PageKind,
  PageScriptRuntime,
  PageRefreshSpec,
