...
3. **Keep brand names in English**: Phaneris, Phaneris Agent, Agents, Workspace, Claude, Anthropic, OpenAI, MCP, API, SDK. The third-party Craft service is a source integration, not this product — leave its name alone.
