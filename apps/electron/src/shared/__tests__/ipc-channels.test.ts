...
const EXPECTED_CHANNELS: string[] = [
  ...
  "browser-pane:stop",
  "caching:getContextPolicy",
  "caching:getExtendedPromptCache",
  "caching:getPromptCacheWarming",
  "caching:setContextPolicy",
  "caching:setExtendedPromptCache",
  "caching:setPromptCacheWarming",
  "calendar:changed",
  "calendar:create",
  "calendar:delete",
  "calendar:list",
  ...
  "pi:startOAuth",
  "pi:submitOAuthCode",
  "plugins:analyzeInstall",
  "plugins:analyzeUninstall",
  "plugins:changed",
  "plugins:install",
  "plugins:list",
  "plugins:uninstall",
