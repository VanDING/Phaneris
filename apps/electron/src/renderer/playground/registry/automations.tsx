...
const mockAutomations: AutomationListItem[] = [
  ...
  },
  {
    ...
    enabled: true,
    actions: [{ type: 'prompt', prompt: 'Log the label change: "$PHANERIS_LABEL was added" to ~/label-log.txt' }],
    permissionMode: 'allow-all',
  ...
  },
  {
    ...
    actions: [{ type: 'prompt', prompt: 'Session $PHANERIS_SESSION_NAME was marked as done. Summarise what was accomplished.' }],
