...
// Uses shared components from @phaneris/ui where available
// ============================================================================
...
`} />
      ...
      {/* Section: SystemMessage (from @phaneris/ui) */}
      <section>
...
export const messagesComponents: ComponentEntry[] = [
  ...
  },
  {
    ...
    category: 'Chat Messages',
    description: 'Right-aligned user message bubble (from @phaneris/ui)',
  ...
  },
  {
    ...
    name: 'SystemMessage',
    category: 'Chat Messages',
    description: 'System/info/warning/error message (from @phaneris/ui)',
