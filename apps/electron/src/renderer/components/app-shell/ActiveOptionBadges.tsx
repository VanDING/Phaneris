...
import { flattenLabels, parseLabelEntry, formatLabelEntry, formatDisplayValue } from '@phaneris/shared/labels'
...
function PluginBadge({
  ...
  return (
    ...
    >
      <Shapes className="shrink-0 h-3.5 w-3.5 text-muted-foreground" strokeWidth={1.75} />
