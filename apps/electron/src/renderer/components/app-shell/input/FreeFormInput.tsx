    ...
    <form className="craft-composer" onSubmit={handleSubmit}>
      ...
      >
        ...
        {/* Controlled EditPopover for "Add New Label" — opens when user selects
            ...
            Electron but launched the desktop app from the WebUI via `phaneris://`.
          ...
          <DropdownMenu open={modelDropdownOpen} onOpenChange={(open) => { setModelDropdownOpen(open); if (!open) setModelConnectionSubmenu(null) }}>
            ...
            <StyledDropdownMenuContent side="top" align="end" sideOffset={8} className="min-w-[260px]">
              ...
              {pickerMode === 'unavailable' ? (
                ...
                /* Flat list: every connection is a peer. providerType is
                   transport metadata (native Pi catalog vs user-supplied
                   endpoint) and never a user-facing category. */
