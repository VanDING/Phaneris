...
import { setupI18n, i18n, whenI18nReady } from '@phaneris/shared/i18n'
import { redactSensitiveHeadersInPlace, redactSensitiveKeysInPlace } from '@phaneris/shared/utils/redaction'
...
sentryInit(
  {
    ...
    beforeSend(event: ErrorEvent) {
      ...
      // by moving both hooks onto @phaneris/shared/utils redaction.ts.
