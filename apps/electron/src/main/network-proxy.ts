...
import { getNetworkProxySettings, setNetworkProxySettings } from '@phaneris/shared/config/storage';
import type { NetworkProxySettings } from '@phaneris/shared/config/types';
