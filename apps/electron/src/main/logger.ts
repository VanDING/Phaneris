...
import { LOGS_DIR } from '@phaneris/shared/config/paths'
import type {
  MessagingLogContext,
  MessagingLogMeta,
  MessagingLogger,
 ...
 */
export const messagingGatewayLogPath = join(LOGS_DIR, 'messaging-gateway.log')
 ...
 */
export const autoUpdateLogPath = join(LOGS_DIR, 'auto-update.log')
