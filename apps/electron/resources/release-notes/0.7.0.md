...
- **Server-core extraction** — 14 core handlers, session management, services, and domain utilities extracted into `@phaneris/server-core` for reuse across Electron and headless
- **Protocol formalization** — channels, DTOs, and event maps extracted to `@phaneris/shared/protocol` with wire-format stability tests
