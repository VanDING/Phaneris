...
- **Island system** — extracted `Island` and `IslandFollowUpContentView` into the shared `@phaneris/ui` package as reusable primitives for annotation follow-ups and inline content expansion (7c4ba6af, 2432b421, 4397b284)
