...
- **`$PHANERIS_EVENT_DATA` missing labels** — all automation event payloads now include the session's current `labels` array, so webhooks and scripts can access label data. Fixes [#406](https://github.com/lukilabs/craft-agents-oss/issues/406). (0f98f090)
